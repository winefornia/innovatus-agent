...
tasting-room flow is OUTBOUND-initiated: the Vertex agent (vertex_agent/intake.py)
creates a ReservationActionRequest, we post an approval card to a Chat space, a human taps
